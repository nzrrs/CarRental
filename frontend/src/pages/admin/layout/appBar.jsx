...
export default function AppBar(props) {
  return (
    <header className={` fixed w-245 h-16 right-0 bg-[#FFFFFF] border-b border-gray-200
      ...
      <h1 className="text-sm flex items-center gap-2 font-semibold text-gray-800">
        <button onClick={props.toggleSidebar}>
          <FiMenu size={18} className="w-7 h-7 text-gray-600 p-1 rounded-lg hover:bg-gray-100 cursor-pointer" />
        </button>
